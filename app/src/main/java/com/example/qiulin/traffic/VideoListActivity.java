...
public class VideoListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.video_frag);
        ...
        videoList = new ArrayList<VideoViewItem>();
        mAdapter = new VideoListAdapter(VideoListActivity.this, videoList);
        ...
        for(int i = 0; i < 11; i++){
            ...
            executorService.submit(new Runnable() {
                ...
                public void run() {
                    try {
                        VideoViewItem item = new VideoViewItem("视频" + index, index, CPResourceUtil.getDrawableId(VideoListActivity.this, "ds" + index));
