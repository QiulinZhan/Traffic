...
public class SelectPicPopupVideo extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.btn_take_photo:
            ...
            if(status.equals(Environment.MEDIA_MOUNTED)){//判断是否有SD卡
                ...
                new MaterialDialog.Builder(SelectPicPopupVideo.this)
                        .title("提示")
                        .content("没有sd卡")
                        .negativeText("确定")
                        .show();
...
//                mEditor.setPhotoBitmap(photo);
    ...
    public static void launch(Activity activity) {
        ...
        Intent intent = new Intent(activity, SelectPicPopupVideo.class);
